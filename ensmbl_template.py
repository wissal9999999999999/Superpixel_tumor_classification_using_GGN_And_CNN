...
path = f"{curretn_path}/liver_data_graphs_50sp_dnsnet121"
path = "/home/melkor/projects/img_to_graph/graph_folder/liver_data_graphs_10sp_densenet"
...
def dataloader():
    ...
    train_tumor = load_all_from_one_folder(f"{path}/train/tumor",1,1)
